...
CREATE TABLE `computers` (
  ...
  `cooling_system` varchar(100) DEFAULT NULL,
  KEY `computers_products_product_id_fk` (`product_id`),
  CONSTRAINT `computers_products_product_id_fk` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`)
