...
<div class="text-center" style="margin-top: 20px;">
    <form class="form-inline" action="${pageContext.request.contextPath}/products/search/options?orderBy=Name">
            ...
            <td align="right">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="${pageContext.request.contextPath}/products/search/options?searchWord=${searchWord}&orderBy=PriceAsc">Price</a></li>
                        <li><a href="${pageContext.request.contextPath}/products/search/options?searchWord=${searchWord}&orderBy=PriceDesc">Price inverse</a></li>
                        <li><a href="${pageContext.request.contextPath}/products/search/options?searchWord=${searchWord}&orderBy=Name">Name</a></li>
                        <li><a href="${pageContext.request.contextPath}/products/search/options?searchWord=${searchWord}&orderBy=Company">Company</a></li>
                    </ul>
                </div>
            </td>
        </tr>
    ...
    <div align="center">
        <ul class="pagination">
            <c:if test="${currentPage != 1}">
                <li><a href="${pageContext.request.contextPath}/products/search/options?searchWord=${searchWord}&orderBy=${orderBy}&page=${currentPage - 1}">&laquo;</a></li>
            </c:if>
            <c:forEach begin="1" end="${pagesCount}" var="index">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${pageContext.request.contextPath}/products/search/options?searchWord=${searchWord}&orderBy=${orderBy}&page=${index}">${index}</a></li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            <c:if test="${currentPage != pagesCount}">
                <li>
                    <a href="${pageContext.request.contextPath}/products/search/options?searchWord=${searchWord}&orderBy=${orderBy}&page=${currentPage + 1}">&raquo;</a>
                </li>
            </c:if>
        </ul>
    </div>
