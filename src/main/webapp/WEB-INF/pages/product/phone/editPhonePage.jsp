...
<form:form class="form-horizontal" role="form"  action="${pageContext.request.contextPath}/products/changePhone" method="post" modelAttribute="updateProduct">
    ...
    <form:hidden path="type" value="Phones"/>
    ...
    <div class="form-group">
        ...
        <div id="pDual" class="col-sm-10 radio-menu-item">
            <c:choose>
                <c:when test="${product.dualSim == false}">
                    <form:radiobutton path="dualSim" value="${true}" />Yes
                    <form:radiobutton path="dualSim" value="${false}" checked="checked"/>No
                </c:when>
                <c:otherwise>
                    <form:radiobutton path="dualSim" value="${true}" checked="checked"/>Yes
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <form:input id="pSim" type="text" class="form-control" path="simType" placeholder="Sim type" value="${product.simType}"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <form:input id="pMessage" type="text" class="form-control" path="messageType" placeholder="Message type" value="${product.messageType}"/>
