<form:form class="form-horizontal" role="form"  action="${pageContext.request.contextPath}/products/addLaptop" method="post" modelAttribute="productDto">
