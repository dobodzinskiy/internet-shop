...
<form:form class="form-horizontal" role="form"  action="${pageContext.request.contextPath}/products/changeComputer" method="post" modelAttribute="updateProduct">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2" for="pMotherboard">Motherboard:</label>
        <div class="col-sm-10">
            <form:input id="pMotherboard" type="text" class="form-control" path="motherboard" placeholder="Motherboard" value="${product.motherboard}"/>
            <form:errors path="motherboard">
                <br>
                <div class="alert alert-danger">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <form:errors path="motherboard" />
    ...
    <div class="form-group">
        <label class="control-label col-sm-2" for="pCooling">Cooling system:</label>
        <div class="col-sm-10">
            <form:input id="pCooling" type="text" class="form-control" path="coolingSystem" placeholder="Cooling system" value="${product.coolingSystem}"/>
            <form:errors path="coolingSystem">
                <br>
                <div class="alert alert-danger">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <form:errors path="coolingSystem" />
