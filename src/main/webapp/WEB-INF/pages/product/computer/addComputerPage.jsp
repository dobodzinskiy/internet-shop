<form:form class="form-horizontal" role="form"  action="${pageContext.request.contextPath}/products/addComputer" method="post" modelAttribute="productDto">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2" for="pMother">Motherboard:</label>
        <div class="col-sm-10">
            <form:input id="pMother" type="text" class="form-control" path="motherboard" placeholder="Motherboard"/>
    ...
    <div class="form-group">
        <label class="control-label col-sm-2" for="pCoolingSystem">Cooling System:</label>
        <div class="col-sm-10">
            <form:input id="pCoolingSystem" type="text" class="form-control" path="coolingSystem" placeholder="Cooling System"/>
